    ...
    return (
        ...
        >
            <View className="bg-slate-50 dark:bg-slate-900 rounded-[32px] p-8 items-center border border-slate-100 dark:border-slate-800 shadow-sm">
                ...
                <Text className="text-2xl font-bold text-slate-900 dark:text-white mb-1.5">Create account</Text>
                <Text className="text-sm text-slate-500 dark:text-slate-400 mb-8">Start your learning journey</Text>
